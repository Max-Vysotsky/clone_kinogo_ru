          ...
          <div class="main-wrap">
            ...
            <div class="side-right gray-color">
                <div class="main-block items" id="main">
                   <form action="handlersettingcorouselVideo.php" method="POST" class="makevideoform">
                     <input type="text" name="idcarousel"  placeholder="id Of Corousel" class="makevideoinput">
                     <input type="text" name="iditem"  placeholder="id Of Item" class="makevideoinput">
                      <input type="submit">
                    </form>
                </div>
            </div>
