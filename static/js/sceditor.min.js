...
!function () {
  ...
  function vt(i, e) {
    ...
    y.insertHTML = function (e, t) {
      ...
      for (r && v++, i = i || "", u = (a = y.getOuterText(!0, v)).length, a += i, t && (a += y.getOuterText(!1, v)); g--;) if (p = (f = e[g][0]).length, s = Math.max(0, u - p - h), c = -1, r ? (l = a.substr(s).match(new RegExp(m + ft(f) + m))) && (c = l.index + s + l[1].length) : c = a.indexOf(f, s), -1 < c && c <= u && u <= c + p + h) return d = u - c, y.selectOuterText(d, p - d - (/^\S/.test(i) ? 1 : 0)), y.insertHTML(e[g][1]), !0;
  ...
  function kt(l, e) {
    ...
    de.opts.emoticons = e.emoticons || ct.emoticons, M = function () {
      ...
      if (Je(w)) {
        ...
        if (at(m), o) for ((n = m.lastChild) || (n = De("p", {}, d), Fe(m, n)); n.lastChild;) n = n.lastChild, !wt && We(n, "br") && n.previousSibling && (n = n.previousSibling);
