<?php require_once('../db.php'); 
 ...
 $AllArticles    = R::count( 'item', ' `genders` LIKE ? ', ['%Мультфильмы%'] );
  require('../includes/paginatorhead.php'); 
         
  $articles = R::getAll( 'SELECT * FROM `item` WHERE `genders` LIKE ? ORDER BY `id` DESC LIMIT ?,?', ['%Мультфильмы%',$offset, $articlesOnPage] );
?>
<!DOCTYPE html>
<html lang="en">
